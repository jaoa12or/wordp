					...
					<div class="footer_col">
						...
						<div class="footer_content footer_blog">
							...
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/logo2.jpg" alt="https://unsplash.com/@avidenov"></div>
...
<script src="<?php bloginfo('template_url'); ?>/js/contact_custom.js"></script>
