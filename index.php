...
<!-- Home -->
		...
		<div>
			...
			<div class="row">
				...
				<!-- Intro Item -->
					...
					<h2 class="intro_title text-center text_intro">Destinos Nacionales</h2>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item_1">
						...
						<div class="intro_item_background" style="">
                                ...
                                <div class="content_img"><a  href="<?php the_permalink();?>">
			...
			<div class="row intro_items">
				...
				<!-- Intro Item -->
                <h2 class="intro_title text-center text_intro">Destinos Internacionales</h2>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title">Nuestros Convenios</h2>
				</div>
			</div>
								...
								<div class="offers_image_container">
									...
									<div class="offers_image_background" >
									    ...
									    <div class=""><a  href="<?php the_permalink();?>">
                                            <?php if ( has_post_thumbnail() ) { the_post_thumbnail( 'list_convenios_thumbs' ); } ?></a>
	...
	<div class="testimonials">
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<h2 class="section_title">Métodos de pago</h2>
				</div>
			</div>
			<div class="row">
				<div class="col">
					...
					<div class="test_slider_container">
						<div class="owl-carousel owl-theme test_slider">
							...
							<div class="owl-item" >
								<div class="test_item">
									<div class="test_image"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/bogota_logo.png" alt="https://unsplash.com/@anniegray"></div>
							...
							<div class="owl-item" >
								<div class="test_item">
									<div class="test_image"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/bancolombia_logo.png" alt="https://unsplash.com/@anniegray"></div>
						    ...
						    <div class="owl-item" >
								<div class="test_item">
									<div class="test_image"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/davivienda_logo.png" alt="https://unsplash.com/@anniegray"></div>
