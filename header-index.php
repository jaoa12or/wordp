            ...
            <div class="top_bar">
                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            ...
                            <div class="user_box ml-auto">
                                ...
                                <div class="user_box_login user_box_link" id="myBtn"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/icono%20login.png" alt=""> Iniciar Sesión</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                      ...
                      <?php
                        echo do_shortcode( '[pie_register_login]' );
